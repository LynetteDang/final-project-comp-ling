...
2. [industry_mapping.ipynb](https://github.com/LynetteDang/final-project-comp-ling/blob/main/industry_mapping.ipynb) and [industry_analysis_combined.ipynb](https://github.com/LynetteDang/final-project-comp-ling/blob/main/industry_analysis_combined.ipynb): logistic regression classifier training, fitting, and performance evaluation/pre-trained DistilBERT model fitting, and performance evaluation using our custom industry tag mapping to ensure consistency in outcome variables across datasets
